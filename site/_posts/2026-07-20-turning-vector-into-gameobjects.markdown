...
<figure class="post-figure">
  <img src="/assets/images/games/etu/gameplay2.png" alt="Eat the Universe gameplay" loading="lazy">
...
<figure class="post-figure">
  <img src="/assets/images/blog/1_etu_tile_pipeline/shapes_in_tile.png" alt="Example tile with an arrangement of obstacles" loading="lazy">
  <figcaption>Example tile with an arrangement of obstacles</figcaption>
</figure>

<figure class="post-figure">
  <img src="/assets/images/blog/1_etu_tile_pipeline/track_example.png" alt="Example track with different tiles" loading="lazy">
...
<figure class="post-figure">
  <img src="/assets/images/blog/1_etu_tile_pipeline/shapes_moons.png" alt="Moon-shaped obstacle arrangement" loading="lazy">
...
<div class="post-figure-pair">
  <figure class="post-figure">
    <img src="/assets/images/blog/1_etu_tile_pipeline/vector_art_imported.png" alt="Spawning objects with default settings" loading="lazy">
    <figcaption>An example of spawning objects with some default settings</figcaption>
  </figure>
  <figure class="post-figure">
    <img src="/assets/images/blog/1_etu_tile_pipeline/vector_art_imported_adjusted.png" alt="Spawning objects with adjusted settings" loading="lazy">
...
<figure class="post-figure">
  <img src="/assets/images/blog/1_etu_tile_pipeline/generator_overloaded_shape.png" alt="Overloaded shape sampling" loading="lazy">
...
<figure class="post-figure-pair post-figure-pair--shared-caption">
  <div class="post-figure-pair__images">
    <img src="/assets/images/blog/1_etu_tile_pipeline/shapes_top_down_1.png" alt="WIP shape arrangement 1" loading="lazy">
    <img src="/assets/images/blog/1_etu_tile_pipeline/shapes_top_down_2.png" alt="WIP shape arrangement 2" loading="lazy">
  </div>
...
<figure class="post-figure">
  <img src="/assets/images/blog/1_etu_tile_pipeline/solar_system_preview.png" alt="Solar system preview" loading="lazy">
